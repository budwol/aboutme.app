...
- No workflow currently runs `jest --coverage` or publishes a coverage report/threshold — see ADR-adjacent finding in the 2026-09-09 audit (no `coverageThreshold` is configured anywhere in the repo).
