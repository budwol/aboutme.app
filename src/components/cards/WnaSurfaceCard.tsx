...
const WnaSurfaceCardComponent: FC<WnaSurfaceCardProps> = ({
  appColors,
  children,
  stateColor,
  type,
...
const WnaSurfaceCard = memo(WnaSurfaceCardComponent);

WnaSurfaceCard.displayName = "WnaSurfaceCard";

export default WnaSurfaceCard;
