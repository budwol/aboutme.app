...
jest.mock("@components/sections/WnaShareActions", () => {
  const { createElement } = jest.requireActual(
    "react",
  ) as typeof import("react");

  return function MockShareActions(props: unknown) {
    return createElement("WnaShareActions", props as Record<string, unknown>);
  };
});
